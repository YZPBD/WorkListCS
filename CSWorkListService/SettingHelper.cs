    ...
    internal class SettingHelper : IDisposable
    {
        ...
        private void InitSettings()
        {
            ...
            if (File.Exists(xmlfile))
            {
                ...
                doc = null;
                Model.Const.ServiceConsts.ServiceName = _ServiceName;
                Model.Const.ServiceConsts.DisplayName = _DisplayName;
                Model.Const.ServiceConsts.Description = _Description;
            }
            else
            {
                _ServiceName = "CSWorkListService";
                _DisplayName = "Varian CCIP WorkList for ConvertData";
                _Description = "Varian CCIP CSWorkListService";
                throw new FileNotFoundException("Not Found ServiceSetting.xml！");
            }
        }
        #endregion
